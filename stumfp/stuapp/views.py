...
class StudentCreateView(CreateView):
    model = Student
    fields = '__all__'
    template_name = 'stuapp/index.html'
    success_url = reverse_lazy('stulist')


class StudentListView(ListView):
    model = Student
    template_name = 'stuapp/students.html'
    context_object_name = 'stu_list'


class StudentDetailView(DetailView):
    model = Student
    template_name = 'stuapp/showstu.html'
...
class StudentUpdateView(UpdateView):
    model = Student
    fields = '__all__'
    template_name = 'stuapp/editstu.html'
    success_url = reverse_lazy('stulist')# url name


class StudentDeleteView(DeleteView):
    model = Student
    template_name = 'stuapp/deleteStudent.html'
    success_url = '/students/' # url path
